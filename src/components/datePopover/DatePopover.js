...
export default function DatePopover({
    ...
    return (
        <Popover
            ...
            content={
                <div class="date-picker block flex flex-col p-2 max-w-sm bg-white rounded-sm border border-white-200 shadow-sm">
                    <DateRangePicker
                        space={space}
                        state={state}
        ...
        >
            <a
                class="block px-5 text-center py-2 max-w-sm bg-white rounded-sm shadow-new cursor-pointer min-w-[400px]"
